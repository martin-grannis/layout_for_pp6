            ...
            children: [
              Expanded(
                ...
                child: ListView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: state.known_hosts.isNotEmpty
                      ? state.known_hosts.length
                      : 0,
                  //itemCount: 0,
              ...
              Expanded(
                ...
                child: ListView.builder(
                  scrollDirection: Axis.vertical,
                  shrinkWrap: true,
                  itemCount: state.saved_hosts.isNotEmpty
                      ? state.saved_hosts.length
                      : 0,
                  //itemCount: 0,
                  padding: EdgeInsets.zero,
                  itemBuilder: (BuildContext context1, int index) {
                    return GestureDetector(
                      ...
                      onTap: () {
                        ...
                        showDialog(
                                    ...
                                    child: Column(
                                      ...
                                      children: [
                                        ...
                                        Dialog(
                                          ...
                                          // TODO
                                          child: GetHostDialogForm(
                                            thisHost: state.saved_hosts[index],
                                            fromSavedList: true,
                                          ),
                                        ),
                                      ],
                          ...
                          BlocProvider.of<AvailableHostsBloc>(context)
                              .add(RemoveSavedHost(state.saved_hosts[index]));
                          //setState(() {});
                        });
                      },
                      child: Padding(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                Expanded(
                                  flex: 9,
                                  child: Text(
                                    "${state.saved_hosts[index].name} ${state.saved_hosts[index].favourite ? '*' : ''}",
                                    style: Theme.of(context)
                                        .textTheme
                                        .bodyText1
                                        ?.copyWith(fontSize: size.width * .013),
